...
//         },  console.log(" about:abouts[0],",intros[0]) )
...
router.post("/update-about",async (req,res)=>{
    try{
        ...
        console.log(" about:abouts[0]ddffddf,",req.body);
    }catch(error){
        res.status(500).send(error);
    }
})
...
//       });
//     } catch (error) {
//       console.error("Error fetching portfolio data:", error); // Logs error to console
//       res.status(500).send({ error: "Internal Server Error" }); // Respond with a 500 status and error message
//     }
//   });
